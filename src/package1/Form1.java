...
public class Form1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/package1/variant.jpg"))); // NOI18N
        getContentPane().add(jLabel4);
        jLabel4.setBounds(140, 10, 270, 100);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (x <= 7) { // Вычисление выражения
            y = (float) ((float) (x + 4) / (Math.pow(a, 2) + Math.pow(b, 2)));
        } else {
            y = (float) (x * (Math.pow(a + b, 2)));
        }
